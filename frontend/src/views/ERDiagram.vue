<template>
  <div class="er-diagram-page animate-fade-in" :class="{ 'web-fullscreen-mode': isWebFullScreen }">
    <div class="page-header" v-if="!isWebFullScreen">
      <div class="title-section">
        ...
        <p class="page-subtitle">快速生成直观的数据库实体关系图，助力架构设计</p>
      </div>
    ...
    <div class="window-container glass" :class="{ 'is-web-fullscreen': isWebFullScreen }">
      <div class="window-header">
        ...
        <div class="window-address">
          feishu.cn/docx/E-R-Diagram-Generator
        </div>
...
const openInNewTab = () => {
  window.open('https://ai.feishu.cn/docx/WWSQdrwTBoTW7nxguIScL39NnMe', '_blank')
}
