<template>
  <div class="usecase-diagram-page animate-fade-in" :class="{ 'web-fullscreen-mode': isWebFullScreen }">
    <div class="page-header" v-if="!isWebFullScreen">
      <div class="title-section">
        ...
        <p class="page-subtitle">可视化展示系统功能与用户交互，支持在线协作与模板套用</p>
      </div>
      <div class="header-actions">
        ...
        <el-button type="primary" @click="openInNewTab" class="action-btn-primary secondary-bg">
